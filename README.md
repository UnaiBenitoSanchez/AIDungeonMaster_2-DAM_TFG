...
- **JDK 17** o compatible con la configuración del proyecto
- **Gradle** gestionado por wrapper
- Dispositivo Android físico o emulador

### Requisitos opcionales según módulos
...
```bash
git clone https://github.com/tuusuario/AIDungeonMaster.git
cd AIDungeonMaster
```

### 2. Abrir en Android Studio
Abrir la carpeta raíz del proyecto y permitir la sincronización de Gradle.

### 3. Configurar credenciales y claves
El proyecto requiere credenciales para varios servicios externos. Estas claves no deben subirse al repositorio.

Normalmente se configuran mediante:
- `local.properties`
- `gradle.properties`
- variables de entorno
- archivos de configuración excluidos por `.gitignore`
...
- archivo `google-services.json` ubicado en el módulo `app/`.

### 5. Sincronizar y compilar
Desde Android Studio o mediante consola:
...
O directamente desde Android Studio sobre un dispositivo conectado o emulador.
